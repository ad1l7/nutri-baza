...
SLOT_TYPES = [
    ...
    ('smoothie',  'Смузи'),
    ('sandwich',  'Сэндвичи'),
    # Диетическая линейка для желудочно-кишечного тракта. В iiko это отдельная
    # группа внешнего меню «ЖКТ (желудочно кишечный тракт)», а не тип блюда,
    # поэтому салаты и горячее этой линейки лежат здесь, а не в «Салат»/«Горячее».
    ('jkt',       'ЖКТ'),
    ('extra',     'Доп. товары'),
]
