...
(/api/v2/assemblyCharts/getTree): дерево ТК раскрываем сами до конечного сырья.
getPrepared здесь не годится — он не заходит в полуфабрикаты со списанием
DIRECT и теряет их ингредиенты. Из списка убираем упаковку (У*) и «Смесь газ»,
срезаем префиксы (С*, П* и т.п.), убираем дубли. Если карты нет — фолбэк на
